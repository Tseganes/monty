...
/**
 * get_int - get a character pointer to new string containing int
 ...
 * @num: number to get legth needed for
 * @base: base of number representation used by buffer
 *
 * Return: integer containing length of buffer needed (doesnot contain null bt)
 */
int get_numbase_len(unsigned int num, unsigned int base)
{
	int len = 1;
 ...
 * @base: base of number used in conversion, omly works up to base 36
